...
#define __ZDCMSCORE_H_
	...
	#define ZD_FSYS_CLKSET_XT_DIV1  0x70
	...
	#define ZD_FSYS_CLKSET_DEFAULT ZD_FSYS_CLKSET_XT_DIV1
	
	#define ZD_FSYS_CLKSET(clkset) OSCCON&=(~(BIT6|BIT5|BIT4|BIT0)),OSCCON|=(clkset)
	...
	*/
	...
	#define ZD_ADC_CH15_ENABLE ZD_PORTB_DIR|=BIT0,ANSEL1|=BIT0
	#define ZD_ADC_CH14_ENABLE ZD_PORTB_DIR|=BIT1,ANSEL1|=BIT1
	#define ZD_ADC_CH13_ENABLE ZD_PORTB_DIR|=BIT2,ANSEL1|=BIT2
	#define ZD_ADC_CH12_ENABLE ZD_PORTB_DIR|=BIT3,ANSEL1|=BIT3
	#define ZD_ADC_CH11_ENABLE ZD_PORTB_DIR|=BIT4,ANSEL1|=BIT4

	#define ZD_ADC_CH17_ENABLE ZD_PORTC_DIR|=BIT0,ANSEL2|=BIT0
	#define ZD_ADC_CH16_ENABLE ZD_PORTC_DIR|=BIT1,ANSEL2|=BIT1
