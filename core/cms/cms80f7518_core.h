...
#define __ZDCMSCORE_H_
	...
	#include "Device\CMS80fx51x\Include\cms80fx51x.h"

	#include "Device\CMS80fx51x\Touch\TouchKeyConst.h"
	...
	#define ZD_T0IE_ENABLE ET0=1
	#define ZD_T0IE_DISABLE ET0=0
	...
	#define ZD_PORTF_PHRES P5UP
	#define ZD_PORTF_PDRES P5RD

	#define ZD_PORT5 ZD_PORTE
	#define ZD_PORT5_DIR ZD_PORTF_DIR
	#define ZD_PORT5_7 ZD_PORTF_7
	#define ZD_PORT5_6 ZD_PORTF_6
	#define ZD_PORT5_5 ZD_PORTF_5
	#define ZD_PORT5_4 ZD_PORTF_4
	#define ZD_PORT5_3 ZD_PORTF_3
	#define ZD_PORT5_2 ZD_PORTF_2
	#define ZD_PORT5_1 ZD_PORTF_1
	#define ZD_PORT5_0 ZD_PORTF_0
	#define ZD_PORT5_PHRES ZD_PORTF_PHRES
	#define ZD_PORT5_PDRES ZD_PORTF_PDRES
	...
	*/
	...
	//CMS80F7518
	#define ZD_ADC_CH0_ENABLE P00CFG=0x01;//ADCCHS=0;
	#define ZD_ADC_CH1_ENABLE P01CFG=0x01;//ADCCHS=1;
	#define ZD_ADC_CH2_ENABLE P02CFG=0x01;//ADCCHS=2;
	#define ZD_ADC_CH3_ENABLE P03CFG=0x01;//ADCCHS=3;
	#define ZD_ADC_CH4_ENABLE P04CFG=0x01;//ADCCHS=4;
	#define ZD_ADC_CH5_ENABLE P05CFG=0x01;//ADCCHS=5;
	#define ZD_ADC_CH6_ENABLE P06CFG=0x01;//ADCCHS=6;
	#define ZD_ADC_CH7_ENABLE P07CFG=0x01;//ADCCHS=7;

	#define ZD_ADC_CH8_ENABLE  P10CFG=0x01;//ADCCHS=8;
	#define ZD_ADC_CH9_ENABLE  P11CFG=0x01;//ADCCHS=9;
	#define ZD_ADC_CH10_ENABLE P12CFG=0x01;//ADCCHS=10;
	#define ZD_ADC_CH11_ENABLE P13CFG=0x01;//ADCCHS=11;
	#define ZD_ADC_CH12_ENABLE P14CFG=0x01;//ADCCHS=12;
	#define ZD_ADC_CH13_ENABLE P15CFG=0x01;//ADCCHS=13;
	#define ZD_ADC_CH14_ENABLE P16CFG=0x01;//ADCCHS=14;
	#define ZD_ADC_CH15_ENABLE P17CFG=0x01;//ADCCHS=15;

	#define ZD_ADC_CH16_ENABLE P20CFG=0x01;//ADCCHS=16;
	#define ZD_ADC_CH17_ENABLE P21CFG=0x01;//ADCCHS=17;
	#define ZD_ADC_CH18_ENABLE P22CFG=0x01;//ADCCHS=18;
	#define ZD_ADC_CH19_ENABLE P23CFG=0x01;//ADCCHS=19;

	#define ZD_ADC_CH39_ENABLE P50CFG=0x01;//ADCCHS=39;
	#define ZD_ADC_CH40_ENABLE P51CFG=0x01;//ADCCHS=40;
	#define ZD_ADC_CH41_ENABLE P52CFG=0x01;//ADCCHS=41;
	#define ZD_ADC_CH42_ENABLE P53CFG=0x01;//ADCCHS=42;
	#define ZD_ADC_CH43_ENABLE P54CFG=0x01;//ADCCHS=43;
	#define ZD_ADC_CH44_ENABLE P55CFG=0x01;//ADCCHS=44;

	

	
	 
	#define ZD_ADC_CH_SELECT(adch) ADCCHS= (adch);
	...
	#define ZD_TIMER0_LOAD_SET(x) TH0=(x>>8);TL0=(x);
	#define ZD_TIMER0_LOAD_ADD_SET(x) TH0=(x>>8);TL0+=(x);

	#define ZD_TIMER0_LOAD_RELOAD(x) TH0=(x);
	...
	#define ZD_TIMER0_INIT TMOD&=0xf0;TMOD|=0x02;ZD_TIMER0_CLKSET(ZD_TIMER0_CLKSET_DEFAULT)
