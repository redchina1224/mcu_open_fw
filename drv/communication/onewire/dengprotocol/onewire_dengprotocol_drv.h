...
extern void onewrite_fixed_length_in_isr(void);
extern void onewrite_fixed_length_init(unsigned char i,unsigned char *sendbuf,unsigned char *recvbuf,unsigned char recv_len);
extern void onewrite_fixed_length_send(unsigned char i,unsigned char writelength);//,unsigned char readlength)
